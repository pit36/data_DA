...
def main(query, plot):
    ...
    parser.add_argument("--show", help="Show the plots instead of saving to file", action="store_true")
    parser.add_argument("--query", help="Show the output of the query", action="store_true")
    parser.add_argument("--input", help="Input directory", default=os.path.join(here, "../data"))
    parser.add_argument("--output", help="Output directory", default=os.path.join(here, "../figures"))
